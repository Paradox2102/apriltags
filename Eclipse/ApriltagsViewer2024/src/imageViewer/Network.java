...
//		};	
		...
		private int ProcessHeader(byte[] hdr)
		{
			...
			m_cameraData.m_exposure = buf.getShort();
			...
			m_cameraData.m_cameraNo = buf.get();
...
//						System.out.print(String.format("(%f,%f)", region.m_corners[i][0], region.m_corners[i][1]));
					}
//					System.out.println("");
				}
			}
...
//							System.out.println(String.format("BPS=%f", totalSize * 1000.0 / (double) (time - time0)));
//							time0 = time;
//							totalSize = 0;
//							imageCount = 0;
//						}
