...
import positionViewer.Bezier.BezierPoint;
...
//				m_p0.m_x, m_p0.m_y, m_p1.m_x, m_p1.m_y, m_p2.m_x, m_p2.m_y, m_p3.m_x, m_p3.m_y, m_p4.m_x, m_p4.m_y, m_p5.m_x, m_p5.m_y));
    ...
    public ArrayList<CurvePoint> ComputeSplinePoints(ArrayList<CurvePoint> list, int sample_count) 
    {
        double distance = 0;
        ArrayList<CurvePoint> points = (list == null) ? new ArrayList<CurvePoint>() : list;
    	...
    	for (int i = 0 ; i < sample_count ; i++)
    	{
    		...
    		point.m_heading = Math.atan2(dy, dx);
    		point.m_x = omt5*m_p0.m_x + 5*omt4*t*m_p1.m_x + 10*omt3*t2*m_p2.m_x + 10*omt2*t3*m_p3.m_x + 5*omt*t4*m_p4.m_x + t5*m_p5.m_x;
    		point.m_y = omt5*m_p0.m_y + 5*omt4*t*m_p1.m_y + 10*omt3*t2*m_p2.m_y + 10*omt2*t3*m_p3.m_y + 5*omt*t4*m_p4.m_y + t5*m_p5.m_y;
